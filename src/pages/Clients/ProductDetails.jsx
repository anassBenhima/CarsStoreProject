          ...
          <div className="row">
            ...
            <div className="col-md-7" style={{ display: 'flex', alignItems: 'center', }}>
              <div>
                ...
                <button
                  style={{ backgroundColor: "#e94560", color: 'white', fontWeight: 'bold', width: "100%", height: '50px', borderRadius: '15px', outline: 'none', border: '2px solid lightgray', position: 'relative', marginTop: "40px", }}
                  onClick={commander}
                  disabled={loading}
                >
...
export default ProductDetailsClients
